...
*/
const XPTN = 'Rahmad Pasker'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/rahmad.80'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+62895636761912'; // JANGAN DI UBAH NANTI EROR
const aktif = 'INI LAGI AKTIF TOD'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/FROF0hmWUuwD4WKgcyIEH9'; // DI GANTI AUTO EROR
const youtube = 'https://youtube.com/channel/UCnGKPo3UBoOT3izSUbBo4pQ'; // DI GANTI AUTO EROR
//
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @RahmadPasker`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @RahmadPasker`)
})
...
conn.sendMessage(id, 'apa manggil manggil? tinggal ketik .help untuk menampilkan menu' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'apa manggil manggil? tinggal ketik .help untuk menampilkan menu' ,MessageType.text);
}
...
conn.sendMessage(id, 'aku sayang kamu' ,MessageType.text);
}
else if (text == '.owner'){
conn.sendMessage(id, 'Owner Rahmad Pasker wa.me/+62895636761912' ,MessageType.text);
}
else if (text == 'Rahmad'){
conn.sendMessage(id, 'iya ada apa? ketik .owner bos' ,MessageType.text);
}
else if (text == 'Kurumi'){
conn.sendMessage(id, 'KURUMI itu punya Rahmad Pasker' ,MessageType.text);
}
...
conn.sendMessage(id, 'kawan1 Rasya and Stephen wa.me/+62895636761912' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'kawan2 testing script wa.me/+62895636761912' ,MessageType.text);
}
...
conn.sendMessage(id, 'cie rindu owner ku yaa Rahmad Pasker' ,MessageType.text);
}
else if (text == 'Tohka'){
conn.sendMessage(id, 'TOHKA itu punya Rahmad�' ,MessageType.text);
}
else if (text == 'Chizuru'){
conn.sendMessage(id, 'CHIZURU itu punya Rahmad��' ,MessageType.text);
}
// Fitur
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *Rahmad* , Follow Instagram Mimin Yah😻 : https://instagram.com/rahmad.80' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *Rahmad* , Follow Instagram Mimin Yah😻 : https://instagram.com/rahmad.80' ,MessageType.text);
}

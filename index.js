...
const youtube = 'GADA'; // DI GANTI AUTO EROR
//
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @RahmadBot`)
})
...
conn.sendMessage(id, 'Owner RahmadPasker wa.me/+62895636761912' ,MessageType.text);
}
else if (text == 'Rahmad'){
conn.sendMessage(id, 'hayoo lagi ngomongin owner ku ya' ,MessageType.text);
}
else if (text == 'Kurumi'){
conn.sendMessage(id, 'KURUMI itu punya Rahmad!😠' ,MessageType.text);
}
...
conn.sendMessage(id, 'TOHKA itu punya Rahmaf!😠' ,MessageType.text);
}
